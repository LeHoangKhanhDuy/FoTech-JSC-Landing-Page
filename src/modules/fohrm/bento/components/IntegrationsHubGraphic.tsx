...
export const IntegrationsHubGraphic: React.FC = () => {
  ...
  return (
    ...
    >
          ...
          return (
            ...
            >
              <button
                ...
                className={`group relative flex items-center gap-1 sm:gap-1.5 px-2 sm:px-3 py-1 sm:py-1.5 rounded-full border transition-all duration-200 text-[10px] sm:text-xs md:text-sm font-medium whitespace-nowrap shadow-lg cursor-pointer ${
                  isHovered
                    ? 'bg-slate-800 border-blue-400/60 text-white shadow-blue-500/20 scale-105'
      ...
      <div className="absolute top-[145px] left-1/2 -translate-x-1/2 -translate-y-1/2 z-10">
        <div className="group relative inline-flex items-center gap-1.5 sm:gap-2 px-3.5 sm:px-4 py-1.5 sm:py-2 rounded-full bg-blue-500 text-white font-bold text-xs sm:text-sm shadow-[0_0_25px_rgba(255,255,255,0.25)] hover:scale-105 transition-all duration-200 cursor-default select-none">
