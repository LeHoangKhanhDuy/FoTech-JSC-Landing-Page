          ...
          <div className="relative w-full max-w-md rounded-2xl bg-slate-50/90 dark:border-slate-700/60 dark:bg-[#071225] p-5 shadow-md dark:shadow-2xl overflow-hidden backdrop-blur-xl transition-all duration-300">
              ...
              <div className="space-y-3">
                <div className="h-28 rounded-xl bg-gradient-to-br from-blue-50 to-indigo-50/80 dark:from-blue-900/40 dark:to-slate-900/80 border border-blue-100 dark:border-slate-800/80 p-3.5 flex flex-col justify-between">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs font-bold text-slate-900 dark:text-white">FoTech Web Builder</span>
                    </div>
                ...
                <div className="grid grid-cols-2 gap-2.5">
                  <div className="rounded-lg border border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900/80 p-3 text-xs shadow-sm">
                    <span className="text-slate-500 dark:text-slate-400 block text-[10px]">Tốc độ tải trang</span>
                    <span className="text-base font-extrabold text-blue-600 dark:text-blue-400">0.8s</span>
                  </div>
                  <div className="rounded-lg border border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900/80 p-3 text-xs shadow-sm">
                    <span className="text-slate-500 dark:text-slate-400 block text-[10px]">Tỷ lệ chuyển đổi</span>
                    <span className="text-base font-extrabold text-emerald-600 dark:text-emerald-400">+345%</span>
                  </div>
                </div>
              </div>
            )}
            ...
            {data.previewType === 'fohrm' && (
              <div className="space-y-3">
                <div className="h-28 rounded-xl bg-gradient-to-br from-indigo-50 to-blue-50/80 dark:from-indigo-900/40 dark:to-slate-900/80 border border-indigo-100 dark:border-slate-800/80 p-3.5 flex flex-col justify-between">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs font-bold text-slate-900 dark:text-white">FoHRM AI Dashboard</span>
                    </div>
                  ...
                  <div className="flex items-center justify-between mt-2 pt-2 border-t border-indigo-100 dark:border-slate-800/80">
                    <div>
                      <span className="text-[10px] text-slate-500 dark:text-slate-400 block">Chấm công hôm nay</span>
                      <span className="text-sm font-bold text-slate-900 dark:text-white">99.2% Nhân sự</span>
                    </div>
                ...
                <div className="grid grid-cols-2 gap-2.5">
                  <div className="rounded-lg border border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900/80 p-3 text-xs shadow-sm">
                    <span className="text-slate-500 dark:text-slate-400 block text-[10px]">Tự động hóa Payroll</span>
                    <span className="text-base font-extrabold text-indigo-600 dark:text-indigo-400">100% AI</span>
                  </div>
                  <div className="rounded-lg border border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900/80 p-3 text-xs shadow-sm">
                    <span className="text-slate-500 dark:text-slate-400 block text-[10px]">Thời gian xử lý</span>
                    <span className="text-base font-extrabold text-emerald-600 dark:text-emerald-400">&lt; 3 phút</span>
                  </div>
                </div>
              </div>
            )}
            ...
            {data.previewType === 'troovn' && (
              <div className="space-y-3">
                <div className="h-28 rounded-xl bg-gradient-to-br from-amber-50 to-orange-50/80 dark:from-amber-900/40 dark:to-slate-900/80 border border-amber-100 dark:border-slate-800/80 p-3.5 flex flex-col justify-between">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs font-bold text-slate-900 dark:text-white">Troo.vn PropTech Platform</span>
                    </div>
                  ...
                  <div className="flex items-center justify-between mt-2 pt-2 border-t border-amber-100 dark:border-slate-800/80">
                    <div>
                      <span className="text-[10px] text-slate-500 dark:text-slate-400 block">Tự động chốt điện nước</span>
                      <span className="text-sm font-bold text-slate-900 dark:text-white">Xuất hóa đơn Zalo/App</span>
                    </div>
                ...
                <div className="grid grid-cols-2 gap-2.5">
                  <div className="rounded-lg border border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900/80 p-3 text-xs shadow-sm">
                    <span className="text-slate-500 dark:text-slate-400 block text-[10px]">Tỷ lệ lấp đầy phòng</span>
                    <span className="text-base font-extrabold text-amber-600 dark:text-amber-400">98.5%</span>
                  </div>
                  <div className="rounded-lg border border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900/80 p-3 text-xs shadow-sm">
                    <span className="text-slate-500 dark:text-slate-400 block text-[10px]">Hợp đồng điện tử</span>
                    <span className="text-base font-extrabold text-emerald-600 dark:text-emerald-400">100% Digital</span>
                  </div>
                </div>
              </div>
            )}
            ...
            {data.previewType === 'fomed' && (
              <div className="space-y-3">
                <div className="h-28 rounded-xl bg-gradient-to-br from-rose-50 to-pink-50/80 dark:from-rose-900/40 dark:to-slate-900/80 border border-rose-100 dark:border-slate-800/80 p-3.5 flex flex-col justify-between">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs font-bold text-slate-900 dark:text-white">FoMed EMR System</span>
                    </div>
                  ...
                  <div className="flex items-center justify-between mt-2 pt-2 border-t border-rose-100 dark:border-slate-800/80">
                    <div>
                      <span className="text-[10px] text-slate-500 dark:text-slate-400 block">Số bệnh án EMR</span>
                      <span className="text-sm font-bold text-slate-900 dark:text-white">50.000+ Hồ sơ</span>
                    </div>
                ...
                <div className="grid grid-cols-2 gap-2.5">
                  <div className="rounded-lg border border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900/80 p-3 text-xs shadow-sm">
                    <span className="text-slate-500 dark:text-slate-400 block text-[10px]">Giảm thời gian chờ</span>
                    <span className="text-base font-extrabold text-rose-600 dark:text-rose-400">-90%</span>
                  </div>
                  <div className="rounded-lg border border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900/80 p-3 text-xs shadow-sm">
                    <span className="text-slate-500 dark:text-slate-400 block text-[10px]">Kho dược tự động</span>
                    <span className="text-base font-extrabold text-emerald-600 dark:text-emerald-400">Chính xác 100%</span>
                  </div>
                </div>
              </div>
            )}
            ...
            {data.previewType === 'focode' && (
              <div className="space-y-3">
                <div className="h-28 rounded-xl bg-gradient-to-br from-emerald-50 to-teal-50/80 dark:from-emerald-900/40 dark:to-slate-900/80 border border-emerald-100 dark:border-slate-800/80 p-3.5 flex flex-col justify-between">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs font-bold text-slate-900 dark:text-white">FoCode Marketplace</span>
                    </div>
                    <span className="text-[10px] font-bold text-emerald-700 bg-emerald-100 dark:text-emerald-400 dark:bg-emerald-950/80 px-2 py-0.5 rounded-full border border-emerald-300/80 dark:border-emerald-500/30">
                      1.000+ Repos
                    </span>
                  ...
                  <div className="flex items-center justify-between mt-2 pt-2 border-t border-emerald-100 dark:border-slate-800/80">
                    <div>
                      <span className="text-[10px] text-slate-500 dark:text-slate-400 block">Bàn giao mã nguồn</span>
                      <span className="text-sm font-bold text-slate-900 dark:text-white">Tự động 1-Click</span>
                    </div>
                ...
                <div className="grid grid-cols-2 gap-2.5">
                  <div className="rounded-lg border border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900/80 p-3 text-xs shadow-sm">
                    <span className="text-slate-500 dark:text-slate-400 block text-[10px]">Tiết kiệm thời gian</span>
                    <span className="text-base font-extrabold text-emerald-600 dark:text-emerald-400">80% Dev</span>
                  </div>
                  <div className="rounded-lg border border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900/80 p-3 text-xs shadow-sm">
                    <span className="text-slate-500 dark:text-slate-400 block text-[10px]">Kiểm duyệt Clean Code</span>
                    <span className="text-base font-extrabold text-blue-600 dark:text-blue-400">100% Clean</span>
                  </div>
                </div>
              </div>
            )}
            ...
            {data.previewType === 'custom' && (
              <div className="space-y-3">
                <div className="h-28 rounded-xl bg-gradient-to-br from-amber-50 to-yellow-50/80 dark:from-amber-900/40 dark:to-slate-900/80 border border-amber-100 dark:border-slate-800/80 p-3.5 flex flex-col justify-between">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs font-bold text-slate-900 dark:text-white">Enterprise Custom System</span>
                    </div>
                    <span className="text-[10px] font-bold text-amber-700 bg-amber-100 dark:text-amber-400 dark:bg-amber-950/80 px-2 py-0.5 rounded-full border border-amber-300/80 dark:border-amber-500/30">
                      Cloud Native
                    </span>
                  ...
                  <div className="flex items-center justify-between mt-2 pt-2 border-t border-amber-100 dark:border-slate-800/80">
                    <div>
                      <span className="text-[10px] text-slate-500 dark:text-slate-400 block">Kiến trúc hệ thống</span>
                      <span className="text-sm font-bold text-slate-900 dark:text-white">Microservices / ERP</span>
                    </div>
                ...
                <div className="grid grid-cols-2 gap-2.5">
                  <div className="rounded-lg border border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900/80 p-3 text-xs shadow-sm">
                    <span className="text-slate-500 dark:text-slate-400 block text-[10px]">Khả năng mở rộng</span>
                    <span className="text-base font-extrabold text-amber-600 dark:text-amber-400">Unlimited</span>
                  </div>
                  <div className="rounded-lg border border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900/80 p-3 text-xs shadow-sm">
                    <span className="text-slate-500 dark:text-slate-400 block text-[10px]">Đồng hành chuyển giao</span>
                    <span className="text-base font-extrabold text-emerald-600 dark:text-emerald-400">24/7 SLA</span>
                  </div>
                </div>
              </div>
            )}
            ...
            <div className="mt-4 pt-3 border-t border-slate-200 dark:border-slate-800/80 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-semibold text-slate-700 dark:text-slate-300">Sẵn sàng triển khai ngay</span>
              </div>
              <span className="text-[11px] font-bold text-blue-600 dark:text-blue-400">FoTech Ecosystem</span>
            </div>
          </div>
        </div>
