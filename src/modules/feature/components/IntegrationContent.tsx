...
export default function IntegrationContent({
  ...
  return (
    <div className="flex flex-col items-start text-left space-y-6 max-w-xl">
      <div className="inline-flex items-center gap-2 rounded-full border border-blue-500/30 bg-blue-950/60 px-3.5 py-1.5 text-xs font-bold text-blue-400 backdrop-blur-md">
      ...
      <div className="pt-2 flex flex-col sm:flex-row items-stretch sm:items-center gap-4 w-full sm:w-auto">
        <StarBorder
          ...
          textColor="#ffffff"
          borderColor="#3b82f6"
          className="w-full sm:w-auto text-sm font-bold cursor-pointer transition-transform hover:scale-[1.02]"
        >
        ...
        <div className="inline-flex items-center justify-center gap-2.5 rounded-2xl border border-slate-800 bg-slate-900/80 px-4 py-3 text-xs font-semibold text-slate-200 backdrop-blur-md">
