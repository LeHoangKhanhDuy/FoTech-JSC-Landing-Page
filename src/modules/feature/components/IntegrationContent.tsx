  ...
  return (
    <div className="flex flex-col items-start text-left space-y-6 max-w-xl animate-fade-in-up">
      ...
      <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight text-slate-900 dark:text-white leading-[1.12]">
        {data.title}{" "}
        <span className="text-blue-600 dark:text-blue-500">{data.titleHighlight}</span>
      </h2>

      <p className="text-sm sm:text-base leading-relaxed text-justify text-slate-600 dark:text-slate-300">
        {data.subtitle}
      </p>
