...
export default function CentralHub({ hubName }: CentralHubProps) {
  return (
    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20 flex flex-col items-center animate-float-card">
      <div className="absolute -inset-4 rounded-3xl bg-blue-600/25 blur-xl animate-pulse-glow" />
      <div className="absolute -inset-8 rounded-full border border-blue-500/25 animate-ping opacity-25 pointer-events-none" />

      <div className="relative flex flex-col items-center justify-center w-24 h-24 sm:w-28 sm:h-28 rounded-2xl border border-blue-500/40 bg-slate-900/60 shadow-[0_0_50px_rgba(37,99,235,0.35)] backdrop-blur-md transition-all duration-300 hover:scale-105 hover:border-blue-400">
