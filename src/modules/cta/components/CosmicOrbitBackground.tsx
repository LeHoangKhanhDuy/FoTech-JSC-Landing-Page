...
export default function CosmicOrbitBackground() {
  return (
    <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden" aria-hidden="true">
      <div className="absolute inset-0 bg-[#060E28]" />
      ...
      <div className="absolute top-1/2 left-10 -translate-y-1/2 h-96 w-96 rounded-full bg-blue-600/20 blur-3xl" />
      <div className="absolute top-1/2 right-10 -translate-y-1/2 h-96 w-96 rounded-full bg-indigo-600/20 blur-3xl" />
