...
import EcosystemHeader from '@/components/sections/ecosystem/EcosystemHeader';
import FoHRMCard from '@/components/sections/ecosystem/FoHRMCard';
import FoMedCard from '@/components/sections/ecosystem/FoMedCard';
import FoCodeCard from '@/components/sections/ecosystem/FoCodeCard';
import TrooCard from '@/components/sections/ecosystem/TrooCard';
...
export default function EcosystemSection() {
  ...
  const handleOpenConsulting = () => setModalState({ isOpen: true, type: 'consulting' });
    ...
    <section id="ecosystem" className="relative py-24 bg-slate-50 text-slate-900 overflow-hidden dark:bg-[#030817] dark:text-slate-100 transition-colors duration-300">
      ...
      <div className="mx-auto max-w-[1320px] px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-14 grid gap-5 grid-cols-1 lg:grid-cols-2">
          <FoHRMCard />
          <FoMedCard onOpenDemo={handleOpenDemo} />
          <FoCodeCard onOpenConsulting={handleOpenConsulting} />
          <TrooCard onOpenDemo={handleOpenDemo} />
        </div>
