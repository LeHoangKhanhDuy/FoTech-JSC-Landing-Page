...
import { ArrowRight, Play, Pause, Volume2, VolumeX, Sparkles, ShieldCheck, CheckCircle2, Lock, Star } from 'lucide-react';
...
export default function Hero() {
  ...
  return (
    <section id="hero" className="relative overflow-hidden pt-28 pb-16 md:pt-36 md:pb-24 bg-white dark:bg-slate-950">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12 lg:gap-8">
          ...
          <div className="lg:col-span-5 animate-fade-in-up">
            ...
            <div className="mt-8 flex flex-col items-stretch sm:flex-row sm:items-center gap-3.5">
              ...
              <Button
                ...
                icon={<Play className="h-4 w-4 fill-current text-blue-600" aria-hidden="true" />}
                className="px-6"
              >
                Xem Demo
              </Button>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="flex items-center gap-1 text-amber-400">
                    ...
                    <span className="ml-1.5 text-xs font-bold text-slate-900 dark:text-white">4.9/5</span>
                  </div>
          ...
          <div className="lg:col-span-7 relative animate-fade-in-up" style={{ animationDelay: '0.15s' }}>
            ...
            <div className="group relative overflow-hidden rounded-2xl md:rounded-3xl border border-slate-200/80 bg-slate-900 shadow-2xl shadow-blue-900/15 dark:border-slate-800 dark:shadow-black/70">
              ...
              <div className="flex items-center justify-between border-b border-slate-800 bg-slate-900/90 px-4 py-3 backdrop-blur-md">
                ...
                <div className="flex items-center gap-2 rounded-lg border border-slate-800 bg-slate-950/80 px-3.5 py-1 text-[11px] font-medium text-slate-400">
                  ...
                  <span className="text-slate-200 font-semibold">app.fohrm.vn</span>
                  <span className="hidden sm:inline text-slate-500">— Quản trị Nhân sự AI</span>
                </div>
              ...
              <div className="relative aspect-[16/10] w-full overflow-hidden bg-slate-950">
                ...
                <div className="absolute top-4 left-4 flex items-center gap-2 rounded-xl border border-white/20 bg-slate-950/80 px-3 py-1.5 backdrop-blur-md text-white shadow-lg">
                  ...
                  >
                    {isPlaying ? <Pause className="h-3.5 w-3.5" aria-hidden="true" /> : <Play className="h-3.5 w-3.5 fill-current" aria-hidden="true" />}
                  </button>
                </div>
